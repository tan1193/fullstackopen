...
const CountVote = ({ votes, sel }) => {
  ...
  return <p>has {text} vote(s)</p>;
};
const StatTitle = prop => (
  <div>
    <h1>{prop.text}</h1>
  </div>
);
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Buttons callback={() => vote(selected)} text='Vote' />

      <Buttons callback={NextQuote} text='Next anecdote' />
